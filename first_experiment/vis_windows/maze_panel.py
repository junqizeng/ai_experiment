...
class MazePanel:
    def __init__(self, main_window):
        ...
        self.state_slogan.setText(f'   状态: {self.algorithm}算法演示中，共{self.steps}步，点击下一步开始演示')
        ...
        self.explain_slogan.move(230, 570)
    ...
    def update(self, maze_map, ans_process, step_index):
        if self.maze is not None:
            self.maze.hide()
        if step_index == -1:
            maze_tuple = maze_map
            ...
            maze_tuple = ans_process[step_index]
            self.state_slogan.setText(f'   状态: {self.algorithm}算法演示中，当前第{step_index+1}/{self.steps}步')
